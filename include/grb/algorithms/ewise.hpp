...
auto ewise_intersection(A&& a, B&& b, Combine&& combine, M&& mask = M{})
{
  ...
  if (mask.shape() < a.shape()) {
    throw grb::invalid_argument("ewise_intersection: Mask has smaller dimensions than vectors.");
  }
  ...
  using index_type = grb::bigger_integral_t<grb::vector_index_t<A>, grb::vector_index_t<B>>;
